package net.redlemon.better_blacksmithing.misc;
...
import net.redlemon.better_blacksmithing.item.custom.ScytheItem;
import net.redlemon.better_blacksmithing.util.ModTags;
...
public class ClearGrass {
    ...
    private static ActionResult handleAttackBlock(PlayerEntity playerEntity, World world, Hand hand, BlockPos blockPos, Direction direction) {
        ...
        if (playerEntity.isSneaking() || !(stack.getItem() instanceof ScytheItem)) {
            return ActionResult.PASS;
        }
    ...
    private static boolean breakBlocksInRadius(PlayerEntity playerEntity, World world, Hand hand, BlockPos blockPos, BlockState targetedBlock, ItemStack stack) {
        ...
        int radius = getRadiusBasedOnMaterial(((ScytheItem) stack.getItem()).getMaterial());
    ...
    private static int getRadiusBasedOnMaterial(ToolMaterial material) {
        if (material == ToolMaterials.DIAMOND || material == ToolMaterials.NETHERITE) {
            return 2;
        } else return 1;
    }
