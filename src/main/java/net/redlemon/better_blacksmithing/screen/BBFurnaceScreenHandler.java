...
public class BBFurnaceScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final BBFurnaceBlockEntity blockEntity;

    public BBFurnaceScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
